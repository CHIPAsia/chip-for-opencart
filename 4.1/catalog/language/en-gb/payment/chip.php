...
$_['convert_to_processing_disabled'] = 'CHIP convert to processing option are disabled.';

$_['payment_canceled'] = 'Payment Canceled.';
$_['payment_failed'] = 'Payment Failed.';
$_['payment_successful'] = 'Payment Successful.';
$_['payment_refunded'] = 'Payment Refunded.';
...
$_['chip_invoice_url'] = 'CHIP invoice: <a href="https://gate.chip-in.asia/p/%1$s/invoice/" target=_blank>https://gate.chip-in.asia/p/%1$s/invoice/</a>';
