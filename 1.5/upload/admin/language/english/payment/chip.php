...
$_['text_chip'] = '<a href="https://www.chip-in.asia/" taget="_blank"><img src="view/image/payment/chip.png" alt="CHIP" title="CHIP" style="height: 30px; border: 1px solid #EEEEEE;" /></a>';
...
$_['entry_created_order_status'] = 'Created Order Status';
$_['entry_error_order_status'] = 'Error Order Status';
$_['entry_cancelled_order_status'] = 'Cancelled Order Status';
$_['entry_overdue_order_status'] = 'Overdue Order Status';
$_['entry_paid_order_status'] = 'Paid Order Status';
$_['entry_refunded_order_status'] = 'Refunded Order Status';
$_['entry_allow_notes'] = 'Notes';
$_['entry_logo'] = 'Logo';
